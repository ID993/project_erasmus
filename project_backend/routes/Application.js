...
const Application = require('../models/prijava'); // Make sure to import your Application model

// POST route for applications
router.post('/', async (req, res) => {
    try {
        const { gpa, firstMobility, motivationLetter, englishProficiency, destinationLanguage, initiatedLLP } = req.body;
        ...
        res.status(201).json({ message: 'Application submitted successfully!', finalScore: score });
    } catch (error) {
