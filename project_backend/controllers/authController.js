...
const registerUser = async (req, res) => {
    ...
    try {
        ...
        const institution = await Ustanova.findById(ustanova).populate('drzava', 'naziv');
        if (!institution) {
...
module.exports = { registerUser, loginUser, logoutUser, getInstitutions, getRoles, authenticateToken };
